<?php
namespace xytool\PaySdk\Alipay;
...
class sdk extends Base
{
    /**
     * 公共参数
     * @var \xytool\PaySdk\Alipay\Params\PublicParams
     */
    public $publicParams;
    ...
    public function sign($data)
    {
        ...
        {
            case 'RSA':
                $result = \xytool\PaySdk\Lib\Encrypt\RSA::$method($content, $key);
                break;
            case 'RSA2':
                $result = \xytool\PaySdk\Lib\Encrypt\RSA2::$method($content, $key);
                break;
            default:
