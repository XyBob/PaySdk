...
use xytool\PaySdk\Lib\Encrypt\RSA;
use xytool\PaySdk\Lib\ObjectToArray;
use xytool\PaySdk\Weixin\Report\Request;
use xytool\PaySdk\Weixin\Params\PublicParams;
...
class sdk extends Base
{
    /**
     * 公共参数
     * @var \xytool\PaySdk\Weixin\Params\PublicParams
     */
    public $publicParams;

    /**
     * 用于上报的SDK实例
     * @var \xytool\PaySdk\Weixin\SDK
     */
    public $reportSDK;
